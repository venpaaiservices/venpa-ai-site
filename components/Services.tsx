...
const products: Service[] = [
  ...
  },
  {
    ...
    description: 'Advanced AI engines that analyze complex datasets to predict trends, optimize logistics, and automate resource allocation.',
    icon: BarChart3,
...
const services: Service[] = [
  ...
  },
  {
    ...
    description: 'Private knowledge AI systems connected securely to your enterprise data for context-aware, verifiable intelligence.',
    icon: Database,
  ...
  },
  {
    ...
    description: 'End-to-end AI product development from concept and architecture to production-grade deployment.',
    icon: Cpu,
    gradient: 'from-orange-500 to-red-600'
  },
  {
