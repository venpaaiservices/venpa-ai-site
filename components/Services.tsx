...
const products: Service[] = [
  ...
  },
  {
    ...
    title: 'Enterprise-Grade "Private" AI Gateways',
    description: 'An API gateway with robust identity management (Keycloak) and SSO. Scrubs PII and confidential data before LLM processing, re-inserting it for the final response. "Give your employees the power of AI without risking a multi-million dollar data breach."',
    icon: ShieldCheck,
  ...
  },
  {
    ...
    description: 'Agentic AI systems that execute multi-step workflows—from auditing compliance to managing supply chain logistics. Save millions in operational costs by automating end-to-end enterprise processes.',
    icon: Workflow,
